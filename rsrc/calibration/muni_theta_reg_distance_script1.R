...
site_level_theta <- site_level_theta %>%
  ...
  summarise(
    ...
    theta_true = weighted.mean(
      slaughter_value_per_ha_2017 / mean_pa_2017,
      w = muni_site_area,
      na.rm = TRUE
    ), 
...
write.csv(site_level_theta, file = "C:\\Users\\pengyu\\Desktop\\HMC_re_results\\theta\\calib_output.csv", row.names = FALSE)
