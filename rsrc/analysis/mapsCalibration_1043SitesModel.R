...
ggplot2::ggsave(filename = here::here("results/calibration/1043SitesModel/map_z2017_1043Sites.png"), width = 8, height = 6)
...
ggplot2::ggsave(filename = here::here("results/calibration/1043SitesModel/map_zbar_2017_1043Sites.png"), width = 8, height = 6)

# share_z_2017_1043Sites
ggplot2::ggplot(data = calibration.1043SitesModel %>%
                  dplyr::mutate(share_z_2017_1043Sites = (z_2017_1043Sites/(zbar_2017_1043Sites))*100,
                                share_z_2017_1043Sites = cut(round(share_z_2017_1043Sites), breaks = c(0,0.5,20,40,60,80,100), include.lowest = T, dig.lab = 3,
...
ggplot2::ggsave(filename = here::here("results/calibration/1043SitesModel/map_z2017Share_1043Sites.png"), width = 8, height = 6)
...
# ggplot2::ggsave(filename = here::here("results/calibration/1043SitesModel/map_A2017_1043Sites.png"), width = 8, height = 6)
...
ggplot2::ggsave(filename = here::here("results/calibration/1043SitesModel/map_x2017_1043Sites.png"), width = 8, height = 6)
...
ggplot2::ggsave(filename = here::here("results/calibration/1043SitesModel/map_gamma_1043Sites.png"), width = 8, height = 6)
...
ggplot2::ggsave(filename = here::here("results/calibration/1043SitesModel/map_theta_1043Sites.png"), width = 8, height = 6)
