...
# z_2017_78Sites
plot <- ggplot2::ggplot(data = calibration.78SitesModel %>%
...
ggplot2::ggsave(filename = here::here("plots/calibration/78SitesModel/map_zbar_2017_78Sites.png"), plot = plot, width = 8, height = 6)

# share_z_2017_78Sites
plot <- ggplot2::ggplot(data = calibration.78SitesModel %>%
  dplyr::mutate(
    share_z_2017_78Sites = (z_2017_78Sites / (zbar_2017_78Sites)) * 100,
    share_z_2017_78Sites = cut(round(share_z_2017_78Sites),
