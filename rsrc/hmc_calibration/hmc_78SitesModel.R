...
site.gamma2017 <-
  sf::st_intersection(calibration.78SitesModel %>% dplyr::select(id),
...
# residuals_data <- residuals(reg.cattleValueperHa.2017)
# squared_residuals <- residuals_data^2
# # Plot histogram
# # png(filename = "residuals_histogram.png")
# # hist(residuals_data, main = "Histogram of Residuals", xlab = "Residuals", ylab = "Frequency", col = "blue",breaks=50)
# # dev.off()

# adjusted_residuals <- squared_residuals / muniTheta.prepData_filtered$pasture_area_2017

# # Plot adjusted residuals
# png(filename = "histogram_adjusted_squared_residuals.png")
# hist(adjusted_residuals, main = "Histogram of Adjusted Squared Residuals", 
#      xlab = "Adjusted Squared Residuals", col = "blue",breaks=30)
# dev.off()
...
write.csv(seriesPriceCattle.prepData, "seriesPriceCattle_prepared.csv", row.names = FALSE)
