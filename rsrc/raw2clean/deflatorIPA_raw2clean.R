...
# read csv file
raw.deflator <-  readr::read_csv2(file = here::here("data/raw2clean/deflatorIPA_fgv/input/ipeadata[23-02-2021-10-02].csv"),
...
save(clean.deflatorIPA,
     file = here::here("data/raw2clean/deflatorIPA_fgv/output",
