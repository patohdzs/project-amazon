...
# read csv file
raw.agCensus2006CattleSlaughter <-  readr::read_csv(file = "data/raw2clean/agCensus2006CattleSlaughter_ibge/input/agCensus2006_cattleSlaughter.csv",
                                  skip = 9,
                                  na = c("..."),
...
raw.agCensus2006CattleSlaughter <-
  ...
  dplyr::summarise(cattleSlaughter2006_value = sum(cattleSlaughter_value, na.rm = T),
...
save(clean.agCensus2006CattleSlaughter,
     file = file.path("data/raw2clean/agCensus2006CattleSlaughter_ibge/output",
