...
#
# > THIS SCRIPT
# AIM: UNIFY TIF FILES BY YEAR - FLORESER (IMAZON - 2000)
# AUTHOR: JOAO VIEIRA
#
# > NOTES
# 1: -
...
# START TIME
tictoc::tic(msg = "floreser2000_raw2clean script", log = T)
...
raw.raster <- do.call(raster::merge, lapply(list.files(file.path("data/raw2clean/floreser_imazon/input/2000"),
                                                       full.names = T,
                                                       pattern = "Floreser_Biome_2000"),
                                            raster::raster))
...
# EXPORT
# save unified tif
raster::writeRaster(raw.raster, "data/raw2clean/floreser_imazon/output/2000/clean_floreser.tif", overwrite = T)
