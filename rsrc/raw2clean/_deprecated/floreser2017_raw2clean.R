...
#
# > THIS SCRIPT
# AIM: UNIFY TIF FILES BY YEAR - FLORESER (IMAZON - 2017)
# AUTHOR: JOAO VIEIRA
#
# > NOTES
# 1: -
...
# START TIME
tictoc::tic(msg = "floreser2017_raw2clean script", log = T)
...
raw.raster <- do.call(raster::merge, lapply(list.files(file.path("data/raw2clean/floreser_imazon/input/2017"),
                                                       full.names = T,
                                                       pattern = "Floreser_Biome_2017"),
                                            raster::raster))
...
# EXPORT
# save unified tif
raster::writeRaster(raw.raster, "data/raw2clean/floreser_imazon/output/2017/clean_floreser.tif", overwrite = T)
