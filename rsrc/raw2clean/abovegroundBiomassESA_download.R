...
aux.params <- tidyr::expand_grid(year = c(2010, 2017, 2018),
                                 tile = c("N00W050", "N00W060", "N00W070", "N00W080",
                                          "N10W050", "N10W060", "N10W070", "N10W080",
                                          "S10W050", "S10W060", "S10W070", "S10W080"))

# download AGB layer
purrr::map2(.x = aux.params$tile,
            .y = aux.params$year,
            .f = ~download.file(url = glue::glue("https://dap.ceda.ac.uk/neodc/esacci/biomass/data/agb/maps/v3.0/geotiff/{.y}/{.x}_ESACCI-BIOMASS-L4-AGB-MERGED-100m-{.y}-fv3.0.tif?download=1"),
...
purrr::map2(.x = aux.params$tile,
            .y = aux.params$year,
            .f = ~download.file(url = glue::glue("https://dap.ceda.ac.uk/neodc/esacci/biomass/data/agb/maps/v3.0/geotiff/{.y}/{.x}_ESACCI-BIOMASS-L4-AGB_SD-MERGED-100m-{.y}-fv3.0.tif?download=1"),
