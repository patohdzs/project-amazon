...
# read csv file
raw.agCensus2017AgUseArea <-  readr::read_csv(file = here::here("data/raw2clean/agCensus2017AgUseArea_ibge/input/agCensus2017_agUseArea.csv"),
                                  skip = 7,
                                  na = c("..."),
...
raw.agCensus2017AgUseArea <-
  raw.agCensus2017AgUseArea %>%
  dplyr::mutate(pasture_area_2017 = rowSums(across(c("pastureNatural_area_2017", "pasturePlantedGood_area_2017", "pasturePlantedBad_area_2017")), na.rm = TRUE),
...
save(clean.agCensus2017AgUseArea,
     file = here::here("data/raw2clean/agCensus2017AgUseArea_ibge/output",
