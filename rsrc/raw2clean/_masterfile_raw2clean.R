...
source(here::here("code/raw2clean/amazonBiome_raw2clean.R"), encoding = "UTF-8", echo = T)
...
source(here::here("code/raw2clean/muniDivision2015_raw2clean.R"), encoding = "UTF-8", echo = T)
...
source(here::here("code/raw2clean/commodityPrices_raw2clean.R"), encoding = "UTF-8", echo = T)
...
source(here::here("code/raw2clean/deflatorIPA_raw2clean.R"), encoding = "UTF-8", echo = T)
...
source(here::here("code/raw2clean/agCensus2017CattleSold_raw2clean.R"), encoding = "UTF-8", echo = T)
...
source(here::here("code/raw2clean/agCensus2017AgUseArea_raw2clean.R"), encoding = "UTF-8", echo = T)
...
source(here::here("code/raw2clean/agCensus2006CattleSlaughter_raw2clean.R"), encoding = "UTF-8", echo = T)
...
source(here::here("code/raw2clean/agCensus2006AgUseArea_raw2clean.R"), encoding = "UTF-8", echo = T)
...
source(here::here("code/raw2clean/emission_raw2clean.R"), encoding = "UTF-8", echo = T)
...
source(here::here("code/raw2clean/emissionKuznets_raw2clean.R"), encoding = "UTF-8", echo = T)
...
source(here::here("code/raw2clean/carbonPrice_raw2clean.R"), encoding = "UTF-8", echo = T)
...
source(here::here("code/raw2clean/landUseCoverMuni_raw2clean.R"), encoding = "UTF-8", echo = T)
...
source(here::here("code/raw2clean/temperature_raw2clean.R"), encoding = "UTF-8", echo = T)
...
source(here::here("code/raw2clean/precipitation_raw2clean.R"), encoding = "UTF-8", echo = T)
...
source(here::here("code/raw2clean/landUseCover_raw2clean.R"), encoding = "UTF-8", echo = T)
...
#source(here::here("code/raw2clean/abovegroundBiomassESA_download.R"), encoding = "UTF-8", echo = T)
