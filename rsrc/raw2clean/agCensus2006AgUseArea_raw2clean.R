...
# DATA INPUT
# read csv file
raw.agCensus2006AgUseArea <- readr::read_csv(
  file = here::here("data/raw2clean/agCensus2006AgUseArea_ibge/input/agCensus2006_agUseArea.csv"),
  skip = 6,
  na = c("..."),
  col_names = c(
    "muni_code",
...
save(clean.agCensus2006AgUseArea,
  file = here::here(
    "data/raw2clean/agCensus2006AgUseArea_ibge/output",
