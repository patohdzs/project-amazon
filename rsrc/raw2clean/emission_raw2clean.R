...
# read csv file
raw.emission <- readxl::read_xlsx(path = here::here("data/raw2clean/emission_seeg/input/emission_agriculture_states.xlsx"),
                                   sheet = 1, col_names = c("state_uf", 1990:2019), skip = 1)

raw.removal <- readxl::read_xlsx(path = here::here("data/raw2clean/emission_seeg/input/removalNCI_agriculture_states.xlsx"),
                                  sheet = 1, col_names = c("state_uf", 1990:2019), skip = 1)
...
save(clean.emission,
     file = here::here("data/raw2clean/emission_seeg/output",
