...
generated quantities {
  ...
  vector<lower=0>[N_theta] nabla_theta = lognormal_rng(X_theta * beta_theta, sqrt(sigma_sq_theta));
  ...
  vector<lower=0>[N_gamma]nabla_gamma = lognormal_rng(X_gamma * beta_gamma, sqrt(sigma_sq_gamma));
