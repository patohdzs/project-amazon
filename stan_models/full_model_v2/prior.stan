...
generated quantities {
  ...
  array[N_theta] real<lower=0> eta_theta = normal_rng(X_theta * beta_theta, sqrt(sigma_sq_theta));
  ...
  array[N_gamma] real<lower=0> eta_gamma = normal_rng(X_gamma * beta_gamma, sqrt(sigma_sq_gamma));
